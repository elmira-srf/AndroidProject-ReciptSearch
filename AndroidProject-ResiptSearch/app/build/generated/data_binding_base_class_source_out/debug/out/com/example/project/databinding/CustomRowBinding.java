...
public final class CustomRowBinding implements ViewBinding {
  ...
  private CustomRowBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imgMeal,
  ...
  public static CustomRowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CustomRowBinding((ConstraintLayout) rootView, imgMeal, tvMealName, tvRegion);
    }
